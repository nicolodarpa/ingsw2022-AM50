...
public class CharacterInfluenceStrategy extends CharacterCardStrategy {
    ...
    public CharacterInfluenceStrategy() {
        setCost(3);
        setEffectOfTheCard("With this card you have to choose one color of the students which will not be considered for the influence. (select a PawnColor before play this card)");
        setName("wizard");
    }
