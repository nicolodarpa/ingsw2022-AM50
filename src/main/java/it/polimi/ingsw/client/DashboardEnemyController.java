...
public class DashboardEnemyController implements  Initializable,DisplayLabel{
    ...
    /**
     * It's the general function that add the color position to its arraylist.
     * The colorPosition is the position of each students' color on the classroom.
     *
     * @param colorPositions is the arraylist which we are considering.
     * @param colorPosition1 is the position of the students' color on the classroom.
     * @param colorPosition2 is the position of the students' color on the classroom.
     * @param colorPosition3 is the position of the students' color on the classroom.
     * @param colorPosition4 is the position of the students' color on the classroom.
     * @param colorPosition5 is the position of the students' color on the classroom.
     * @param colorPosition6 is the position of the students' color on the classroom.
     * @param colorPosition7 is the position of the students' color on the classroom.
     * @param colorPosition8 is the position of the students' color on the classroom.
     * @param colorPosition9 is the position of the students' color on the classroom.
     * @param colorPosition10 is the position of the students' color on the classroom.
     */
