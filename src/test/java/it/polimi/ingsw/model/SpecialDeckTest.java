...
public class SpecialDeckTest {
    ...
    public void extractRandomTest(){
        ...
        CharacterCardStrategy card1 = specialDeckTest.getSpecialCard(0);
        CharacterCardStrategy card2 = specialDeckTest.getSpecialCard(1);
        CharacterCardStrategy card3 = specialDeckTest.getSpecialCard(2);
